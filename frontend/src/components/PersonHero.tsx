...
import { Box, Typography, Avatar, Stack, Button, Paper, useTheme, Grid } from '@mui/material';
...
export function PersonHero({ person, onSave, onMerge, onDelete, onRefreshSimilar, saving }: PersonHeroProps) {
            ...
            <Grid container spacing={{ xs: 2, md: 4 }} alignItems="center">
                ...
                <Grid size={{ xs: 12, sm: 8, md: 9 }}>
                    ...
                    <Typography variant="body1" color="text.secondary" gutterBottom>
                        {person.appearance_count ? `${person.appearance_count} appearances found` : 'No appearances'}
                    </Typography>

                    {!READ_ONLY && (
                        <Stack direction="row" spacing={1} mt={2} mb={3} flexWrap="wrap" useFlexGap>
                            <Button variant="outlined" onClick={onMerge}>Merge</Button>
                            <Button variant="outlined" onClick={onRefreshSimilar}>Refresh Similar</Button>
