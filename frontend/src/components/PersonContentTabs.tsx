...
function TabPanel(props: TabPanelProps) {
    ...
    return (
        <div role="tabpanel" hidden={value !== index} id={`person-tabpanel-${index}`} {...other}>
        ...
        <Box sx={{ width: '100%' }}>
            ...
            <TabPanel value={tabValue} index={0}>
                <Suspense fallback={<CircularProgress />}>
                    <MediaAppearances medias={props.medias} />
                </Suspense>
            </TabPanel>
            ...
            <TabPanel value={tabValue} index={1}>
                ...
                <Suspense fallback={<CircularProgress />}>
                    <DetectedFaces
                        ...
                        onSetProfile={(faceId) => props.handleProfileAssignmentWrapper(faceId, props.person.id)}
