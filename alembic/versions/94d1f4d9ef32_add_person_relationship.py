...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("coappearance_count", sa.Integer(), nullable=False, server_default="0"),
...
def downgrade() -> None:
    op.drop_index("ix_person_relationship_coappearance_count", table_name="person_relationship")
